...
void i2c_init(i2c_t *obj, PinName sda, PinName scl)
{
    ...
    switch ((int)obj->i2c) {
        case I2C_2:
            GPIO_MAP[CMSDK_GPIO_SH0_SCL_I2C_GPIO_NUM]->ALTFUNCSET |=
                                        (1<<CMSDK_GPIO_ALTFUNC_SH0_SCL_I2C_SET);
            GPIO_MAP[CMSDK_GPIO_SH0_SDA_I2C_GPIO_NUM]->ALTFUNCSET |=
                                        (1<<CMSDK_GPIO_ALTFUNC_SH0_SDA_I2C_SET);
            break;
        case I2C_3:
            GPIO_MAP[CMSDK_GPIO_SH1_SCL_I2C_GPIO_NUM]->ALTFUNCSET |=
                                        (1<<CMSDK_GPIO_ALTFUNC_SH1_SCL_I2C_SET);
            GPIO_MAP[CMSDK_GPIO_SH1_SDA_I2C_GPIO_NUM]->ALTFUNCSET |=
                                        (1<<CMSDK_GPIO_ALTFUNC_SH1_SDA_I2C_SET);
            break;
    }
}
